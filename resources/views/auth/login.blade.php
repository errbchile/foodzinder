...
<body>
	...
	<header class="header_in clearfix">
		...
		<div id="logo">
        <a href="{{ url('/') }}">
				<img src="{{asset('plantilla/img/logo_sticky.svg')}}" width="140" height="35" alt="">
			</a>
		</div>
		<ul id="top_menu">
			<li><a href="{{route('login')}}" id="sign-in" class="login">Sign In</a></li>
			<li><a href="{{asset('plantilla/wishlist.html')}}" class="wishlist_bt_top" title="Your wishlist">Your wishlist</a></li>
		</ul>
		<!-- /top_menu -->
		...
		<nav class="main-menu">
			<div id="header_menu">
				...
				<a href="{{asset('plantilla/index.html')}}"><img src="{{asset('plantilla/img/logo.svg')}}" width="140" height="35" alt=""></a>
			</div>
			<ul>
				<li class="submenu">
